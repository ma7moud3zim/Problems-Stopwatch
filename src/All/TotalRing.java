...
public class TotalRing {
  
        
        public static File file = new File("Total.wav");
        AudioInputStream Ring = AudioSystem.getAudioInputStream(file);  
        Clip ringing = AudioSystem.getClip();
        boolean s = false;
        
        public TotalRing() throws UnsupportedAudioFileException, IOException, LineUnavailableException{
